...
export const homeContent: HomeContent = {
  ...
  experience: {
    ...
    logos: [
      { name: "Cambalache",        category: "Restaurantes" },
      { name: "Ryoshi",            category: "Restaurantes" },
      { name: "Puerto Madero",     category: "Restaurantes" },
      { name: "Ruth's Chris",      category: "Restaurantes" },
      { name: "Hiromi",            category: "Restaurantes" },
      { name: "Bandoneon",         category: "Restaurantes" },
      { name: "Marbella",          category: "Restaurantes" },
      { name: "La Vaca Argentina", category: "Restaurantes" },
    ],
  },
