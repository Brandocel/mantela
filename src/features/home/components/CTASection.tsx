  ...
  return (
    <section id="contacto" className="w-full">
      <div className="relative w-full overflow-hidden bg-[#0F172A]">
        ...
        <div className="absolute left-0 top-0 h-[3px] w-full bg-gradient-to-r from-[#00B2A9] via-[#22C55E] to-transparent" />
        {/* Mancha de luz verde — decorativa, sutil */}
        <div className="pointer-events-none absolute -right-32 -top-32 h-[320px] w-[320px] rounded-full bg-[#00B2A9]/[0.06] blur-[80px]" />
        ...
        <div className="mx-auto flex w-full max-w-[1280px] flex-col items-start justify-between gap-8 px-5 py-16 sm:px-8 lg:flex-row lg:items-center lg:px-16 lg:py-[60px]">
          ...
          >
            <p className="mb-4 flex items-center gap-2.5 text-[10px] font-[700] uppercase tracking-[0.2em] text-[#00B2A9]">
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.04, boxShadow: "0 12px 32px rgba(0,178,169,0.38)" }}
              whileTap={{ scale: 0.96 }}
              transition={SPRING}
              className="inline-flex h-[52px] items-center gap-2.5 rounded-none rounded-tl-[18px] rounded-br-[18px] bg-[#00B2A9] px-8 text-[13px] font-[700] tracking-[0.02em] text-white shadow-[0_6px_24px_rgba(0,178,169,0.28)]"
            >
              {content.buttonLabel}
            </motion.a>
          </motion.div>
