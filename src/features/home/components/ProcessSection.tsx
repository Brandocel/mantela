...
> = {
  green: {
    border: "border-[#75CF45]",
    text: "text-[#75CF45]",
    shadow: "shadow-[0_24px_50px_rgba(117,207,69,0.12)]",
  },
  pink: {
    border: "border-[#EF4B91]",
    text: "text-[#EF4B91]",
    shadow: "shadow-[0_24px_50px_rgba(239,75,145,0.12)]",
  },
  purple: {
    border: "border-[#8B4CE6]",
    text: "text-[#8B4CE6]",
    shadow: "shadow-[0_24px_50px_rgba(139,76,230,0.12)]",
  },
};
...
function BasketIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden>
      <path
        d="M15 21H33L31.5 38H16.5L15 21Z"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinejoin="round"
      />
      <path
        d="M18 21V16C18 12.7 20.7 10 24 10C27.3 10 30 12.7 30 16V21"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinecap="round"
      />
...
function IronIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden>
      <path
        d="M11 33H38C39.6 33 40.6 31.3 39.8 29.9L35.7 22.7C34.6 20.7 32.5 19.5 30.2 19.5H20"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinejoin="round"
      />
      <path
        d="M11 33C12 28 15.5 24 20 22"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinecap="round"
      />
...
function ShirtIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden>
      <path
        d="M17 10L11 15L7 23L14 26L17 20V39H31V20L34 26L41 23L37 15L31 10"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinejoin="round"
      />
      <path
        d="M17 10C18.8 13 21 14.5 24 14.5C27 14.5 29.2 13 31 10"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinecap="round"
      />
...
function ProcessCard({
  ...
  return (
    <article
      className={`relative z-20 flex shrink-0 flex-col items-center justify-center rounded-[10px] border bg-white px-6 text-center ${
        mobile
          ? "w-full min-h-[188px] py-8"
          : "h-[188px] w-[292px]"
      } ${style.border} ${style.shadow} ${className}`}
    >
      <span
        className={`absolute -top-[15px] right-[24px] flex h-[30px] min-w-[30px] items-center justify-center rounded-full border bg-white px-2 text-[12px] font-medium leading-none ${style.border} ${style.text}`}
      >
        {number}
      </span>
    ...
    <section id="proceso" className="relative overflow-hidden bg-white">
      <div className="mx-auto w-full max-w-[1280px] px-6 pb-[90px] pt-[8px] sm:px-10 lg:px-[58px]">
        ...
        <div className="relative mx-auto mt-[56px] hidden max-w-[1060px] pb-[40px] lg:block">
          {/* Líneas punteadas curvas sin flechas */}
          <svg
            ...
            aria-hidden="true"
          >
            {/* Curva superior: 01 → 02 */}
            <path
              d="M292 96C360 24 480 8 548 72C585 105 598 150 586 195"
              stroke="#C0C0C0"
              strokeWidth="2"
              strokeLinecap="round"
              strokeDasharray="8 8"
            />
            {/* Curva inferior: 02 → 03 */}
            <path
              d="M680 265C760 330 900 308 950 205"
              stroke="#C0C0C0"
              strokeWidth="2"
              strokeLinecap="round"
              strokeDasharray="8 8"
          ...
          <div className="relative z-10 flex min-h-[380px] items-start justify-between">
            ...
            {/* Card 03 — derecha arriba */}
            <div className="pt-[56px]">
              {thirdStep && (
                <ProcessCard
                  number={thirdStep.number}
